  ...
  <q-page class="text-center bg-blue-grey-1">
    <div class="row">
      <div class="col-12 q-mt-sm q-px-md">
        <h3 class="text-h6 text-weight-bolder">CONSULTA DE ACTIVIDAD ECONOMICA</h3>
...
<!--                {{ props.row.gestion }}-{{anio}}-->
              ...
              <q-td key="estado" :props="props">
                <q-badge :color="props.row.gest==anio?'positive':'negative'" :label="props.row.gestion==anio?'No tiene deudas':'El inmueble tiene deudas dudas y consultas 69603027'"/>
              </q-td>
            </q-tr>
          </template>
        </q-table>
